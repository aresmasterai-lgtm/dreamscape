...
const sections = [
  {
    ...
    icon: '✦',
    links: [
      { label: 'Home', path: '/', desc: 'Discover Dreamscape and start creating' },
      { label: 'Marketplace', path: '/marketplace', desc: 'Browse and buy artist merchandise' },
      { label: 'Gallery', path: '/gallery', desc: 'Explore AI-generated artwork' },
      { label: 'Channels', path: '/channels', desc: 'Connect with the artist community' },
      { label: 'Create', path: '/create', desc: 'Generate AI artwork with Dream AI' },
      { label: 'Blog', path: '/blog', desc: 'Tips, guides and inspiration for artists' },
    ],
  },
  {
    title: 'Account',
    icon: '👤',
    links: [
      { label: 'My Profile', path: '/profile', desc: 'View and edit your artist profile' },
      { label: 'My Orders', path: '/orders', desc: 'Track your purchases and order history' },
      { label: 'Pricing', path: '/pricing', desc: 'View subscription plans and features' },
    ],
  },
  {
    title: 'Legal & Support',
    icon: '📋',
    links: [
      { label: 'Privacy Policy', path: '/privacy', desc: 'How we collect and use your data' },
...
export default function Sitemap() {
  return (
    <div style={{ padding: '60px 20px', maxWidth: 860, margin: '0 auto' }}>
      ...
      <div style={{ marginTop: 40, background: C.panel, border: `1px solid ${C.border}`, borderRadius: 14, padding: '16px 20px', fontSize: 13, color: C.muted, display: 'flex', alignItems: 'center', gap: 10 }}>
        <span>🤖</span>
        <span>Looking for the XML sitemap? <a href="/sitemap.xml" style={{ color: C.accent, textDecoration: 'none' }}>sitemap.xml</a></span>
      </div>
    </div>
  )
}
